...
import org.camunda.bpm.extension.reactor.projectreactor.bus.filter.PassThroughFilter;
import org.camunda.bpm.extension.reactor.projectreactor.bus.publisher.BusPublisher;
import org.camunda.bpm.extension.reactor.projectreactor.bus.registry.CachingRegistry;
...
import org.camunda.bpm.extension.reactor.projectreactor.bus.selector.ClassSelector;
...
public class EventBus implements Bus<Event<?>>, Consumer<Event<?>> {
	...
	/**
	 * Create a new {@link org.camunda.bpm.extension.reactor.projectreactor.bus.spec.EventBusSpec} to configure a Reactor.
	 *
	...
	/**
	 * Create a new {@link EventBus} using the given {@link org.camunda.bpm.extension.reactor.projectreactor.core.Dispatcher}.
	 *
	 * @param dispatcher The name of the {@link org.camunda.bpm.extension.reactor.projectreactor.core.Dispatcher} to use.
	 * @return A new {@link EventBus}
	 */
	 ...
	 * org.camunda.bpm.extension.reactor.projectreactor.core.Dispatcher}.
	 *
	 * @param env        The {@link Environment} to use.
	 * @param dispatcher The {@link org.camunda.bpm.extension.reactor.projectreactor.core.Dispatcher} to use.
	 * @return A new {@link EventBus}
	 */
	 ...
	 * org.camunda.bpm.extension.reactor.projectreactor.bus.routing.Router} that broadcast events to all of the registered consumers that {@link
	...
	/**
	 * Get the {@link org.camunda.bpm.extension.reactor.projectreactor.bus.routing.Router} used to route events to {@link Consumer Consumers}.
	 *
	 * @return The {@link org.camunda.bpm.extension.reactor.projectreactor.bus.routing.Router}.
	 */
	...
	/**
	 * Register the given {@link Consumer} on an anonymous {@link org.camunda.bpm.extension.reactor.projectreactor.bus.selector.Selector} and
	 ...
	 * org.camunda.bpm.extension.reactor.projectreactor.core.Dispatcher}, passing the given {@param data}.
	 *
