...
package org.camunda.bpm.extension.reactor.projectreactor.bus.timer;
...
import org.camunda.bpm.extension.reactor.projectreactor.bus.selector.HeaderResolver;
...
/**
 * A hashed wheel timer implementation that uses a {@link org.camunda.bpm.extension.reactor.projectreactor.bus.registry.Registry} and custom {@link
 * org.camunda.bpm.extension.reactor.projectreactor.bus.selector.Selector Selectors} to determine when tasks should be executed.
 * <p>
