...
public abstract class Predicates {
   ...
   * {@literal true}.
   *
   * @param predicates {@literal Predicate Predicates} which will be ANDed together.
   ...
   *
   * @param p the {@literal Predicate} to negate
   ...
   *
   * @param p1 A {@literal Predicate} which will be ORed together with {@literal p2}.
   * @param p2 A {@literal Predicate} which will be ORed together with {@literal p1}.
   ...
   *
   * @param p1 A {@literal Predicate} which will be XORed together with {@literal p2}.
   * @param p2 A {@literal Predicate} which will be XORed together with {@literal p1}.
