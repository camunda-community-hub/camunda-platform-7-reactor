...
public abstract class Suppliers {
   ...
   *
   * @param obj       the object to supply
   * @param predicate the predicate to check to determine whether or not to supply the given value
   * @param <T>       type of the supplied object
   * @return the new {@link Supplier}
   */
   ...
   *
   * @param objs the objects to load-balance
   * @param <T>  type of the supplied object
   * @return the new {@link Supplier}
   */
   ...
   *
   * @param c   the collection to consume
   * @param <T> type of the source
   * @return the new {@link Supplier}
   */
   ...
   *
   * @param iters the collections to consume
   * @param <T>   type of the source
   * @return the new {@link Supplier}
   * @see #drain(Iterable)
   */
   ...
   *
   * @param suppliers the list of suppliers to delegate to
   * @param <T>       type of the source
   * @return the new {@link Supplier}
   */
