...
public class Buffer implements Recyclable,
  ...
  /**
   * A delimiting buffer is sent to {@link org.camunda.bpm.extension.reactor.projectreactor.io.codec.BufferCodec} and other components to signal the end of a sequence of Buffer.
   *
   * @since 2.0.4
   */
